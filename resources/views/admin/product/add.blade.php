                        ...
                        <div class="card ">
                            ...
                            <form id="quickForm" action="" method="POST">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label>Giá gốc</label>
                                        <input type="number" name="price" class="form-control" cols="30" rows="10">
                                    </div>
                                    <div class="form-group">
                                        <label>Giá giảm</label>
                                        <input type="number" name="price_sale" class="form-control" cols="30" rows="10">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label>Giá giảm</label>
                                        <input name="thumb" type="file" class="form-control" cols="30" rows="10">
                                    </div>
